...
class SyntaxTest {
    ...
    void syntaxTestMyList() throws NoSuchMethodException{
        ...
        assertEquals("boolean", mList.getMethod("add", Object.class).getReturnType().getName());
    ...
    void syntaxTestPosition() throws NoSuchMethodException, NoSuchFieldException{
        ...
        // Check getDistance
        assertEquals("getDistance", position.getMethod("getDistance", Position.class).getName());
        assertEquals("int", position.getMethod("getDistance", Position.class).getReturnType().getName());
...
class Part2Test {
    ...
    void  positionGetDistance() {
        ...
        // this is different with COMP250. Giulia change it to static, but not me
        // assertEquals(7, Position.getDistance(pos, pos2));
        assertEquals(7, pos.getDistance(pos2));
    }
